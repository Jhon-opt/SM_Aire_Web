-- =============================================================
-- Esquema para cPanel (hosting compartido)
-- Sin CREATE DATABASE ni USE: importa este archivo DENTRO de tu
-- base ya creada (ej: grupomet_airmon) desde phpMyAdmin > Importar.
-- =============================================================
